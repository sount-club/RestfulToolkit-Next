...
public final class RestServiceDetail extends JBPanel<RestServiceDetail> {
    ...
    private ComboBox<String> bodyTypeField;
    ...
    private void initUI() {
        ...
        bodyTypeField = new ComboBox<>(new String[]{BODY_TYPE_NONE, BODY_TYPE_JSON, BODY_TYPE_FORM});
        ...
        JPanel headerPanel = new JBPanel<>(new BorderLayout(0, JBUI.scale(8)));
    ...
    public void addRequestTabbedPane(String title, RSyntaxTextArea jTextArea) {
        ...
        jTextArea.setBackground(new JBColor(new Color(0xFFFFFF), new Color(0x2B2B2B)));
        jTextArea.setForeground(new JBColor(new Color(0x000000), new Color(0xBBBBBB)));
        jTextArea.setSelectionColor(new JBColor(new Color(0xA6D2FF), new Color(0x28437F)));
        jTextArea.setCurrentLineHighlightColor(new JBColor(new Color(0xFCFAED), new Color(0x323232)));
    ...
    private RSyntaxTextArea createDetachedTextArea(String text) {
        return new RSyntaxTextArea(text);
    }
