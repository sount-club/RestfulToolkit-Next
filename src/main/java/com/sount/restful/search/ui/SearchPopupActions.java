...
final class SearchPopupActions {
    ...
    static @NotNull NavigationResult navigateToSelected(@NotNull JBList<SearchResult<RestServiceItem>> resultList,
    ...
    static void copySelectedPath(@NotNull JBList<SearchResult<RestServiceItem>> resultList) {
        SearchResult<RestServiceItem> selected = resultList.getSelectedValue();
        if (selected != null) {
    ...
    static void moveFocusToResults(@NotNull JBList<SearchResult<RestServiceItem>> resultList) {
    ...
    static void moveSelectionFromSearchField(@NotNull JBList<SearchResult<RestServiceItem>> resultList, int direction) {
    ...
    static void selectAndRevealIndex(@NotNull JBList<SearchResult<RestServiceItem>> resultList, int index) {
        selectAndRevealIndex(resultList, index, null, null);
    }

    static void selectAndRevealIndex(@NotNull JBList<SearchResult<RestServiceItem>> resultList,
                                     int index,
    ...
    private static void revealIndex(@NotNull JBList<SearchResult<RestServiceItem>> resultList,
                                    @Nullable Integer preferredFirstVisibleIndex,
                                    @Nullable Integer preferredScrollY,
                                    int selectedIndex) {
    ...
    private static boolean restoreScrollY(@NotNull JBList<SearchResult<RestServiceItem>> resultList,
                                          @Nullable Integer preferredScrollY) {
    ...
    static void installResultListKeyAdapter(@NotNull JBList<SearchResult<RestServiceItem>> resultList) {
