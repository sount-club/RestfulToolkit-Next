...
public class UnifiedSearchRenderer extends JPanel implements ListCellRenderer<SearchResult<RestServiceItem>> {
    ...
    @Override
    public Component getListCellRendererComponent(JList<? extends SearchResult<RestServiceItem>> list,
                                                  SearchResult<RestServiceItem> value,
